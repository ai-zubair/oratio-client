...
function App() {
  ...
  let landingHTML=<>
    ...
    <div className="o-wrapper-l">
        <div className="hero flex flex-column">
            ...
            <div>
                To call your friend, ask them to open Oratio in their browser. <br/>
  ...
  function callPeer(id) {
    if(id!=='' && users[id] && id!==yourID){
      ...
      .catch(()=>{
        setModalMessage('You cannot place/ receive a call without granting video and audio permissions! Please change your settings to use Oratio.')
